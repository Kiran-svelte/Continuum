    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2">Real-time status of Continuum services</p>
        </div>
        ...
        <Card className="mb-8">
          <CardContent className="py-6">
            ...
            <p className="text-center text-sm text-gray-500 mt-2">
              Overall uptime: <span className="font-medium text-gray-900">99.94%</span> over the last 90 days
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {SERVICES.map((service) => (
                <div key={service.name} className="flex items-center justify-between py-3 border-b border-gray-50 last:border-0">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-xs text-gray-400">Latency: {service.latency}</span>
          ...
          <CardContent>
            <div className="space-y-6">
              {RECENT_INCIDENTS.map((incident) => (
                <div key={incident.title} className="border-l-2 border-gray-200 pl-4">
