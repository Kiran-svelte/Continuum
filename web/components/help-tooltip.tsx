...
export function HelpTooltip({ 
  ...
  const arrowClasses = {
    top: 'bottom-[-6px] left-1/2 -translate-x-1/2 border-t-[var(--border)]',
    bottom: 'top-[-6px] left-1/2 -translate-x-1/2 border-b-[var(--border)] rotate-180',
    left: 'right-[-6px] top-1/2 -translate-y-1/2 border-l-[var(--border)] -rotate-90',
    right: 'left-[-6px] top-1/2 -translate-y-1/2 border-r-[var(--border)] rotate-90'
  };
