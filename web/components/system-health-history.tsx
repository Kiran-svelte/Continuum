...
export function SystemHealthHistory({ healthHistory }: SystemHealthHistoryProps) {
  ...
  return (
    <GlassPanel className="overflow-hidden">
      <div className="p-6 border-b border-[#ece5f9] flex items-center justify-between bg-[#faf8ff]">
          ...
          {healthHistory.map((entry, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-[#efe9fb] backdrop-blur-md px-2 py-1 rounded text-[10px] font-bold text-foreground border border-[#ece5f9] opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none">
  ...
  return (
    <GlassPanel className="overflow-hidden">
      <div className="p-6 border-b border-[#ece5f9] flex items-center justify-between bg-[#faf8ff]">
        ...
        <Badge variant="outline" className="text-[10px] border-[#ece5f9]">
          Loading
        </Badge>
      </div>
      <div className="p-8">
        <div className="h-32 rounded-2xl border border-dashed border-[#ece5f9] bg-[#faf8ff] animate-pulse" />
        <div className="flex items-center justify-between mt-6 text-[10px] font-black text-muted-foreground uppercase tracking-widest">
          <span>Buffer Start</span>
