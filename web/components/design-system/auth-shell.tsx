...
export function AuthShell({
  ...
  return (
    <div className={cn('relative min-h-screen overflow-hidden bg-[var(--background)] text-[var(--foreground)]', className)}>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center px-4 py-10 sm:px-6">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[var(--radius-xl)] border border-[var(--border)] bg-[var(--card)] shadow-[var(--shadow-lg)] lg:grid-cols-[1.05fr_1fr]">
          <aside className="hidden flex-col justify-between border-r border-[var(--border)] bg-[color-mix(in_srgb,var(--primary)_10%,var(--background))] p-10 lg:flex">
