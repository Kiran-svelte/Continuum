      ...
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 animate-pulse">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="h-3 w-20 bg-[var(--accent)] rounded" />
          </div>
          <div className="h-4 w-16 bg-[var(--accent)] rounded" />
          <div className="h-4 w-10 bg-[var(--accent)] rounded" />
          <div className="h-6 w-16 bg-[var(--accent)] rounded-full" />
          <div className="h-4 w-20 bg-[var(--accent)] rounded" />
          <div className="h-8 w-36 bg-[var(--accent)] rounded" />
        </div>
      ))}
    </div>
  );
...
export default function LeaveEncashmentView() {
