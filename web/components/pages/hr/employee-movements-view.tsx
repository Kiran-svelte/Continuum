...
export default function EmployeeMovementsView() {
  // Auth
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface-hover)] p-6 space-y-3">
              <div className="flex items-center justify-between">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface-hover)]">
    ...
    <StaggerContainer className="space-y-6">
      ...
      <FadeIn>
        <div className="flex flex-wrap items-center gap-3">
              ...
              <Button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${
                  statusFilter === f.value
                    ...
                    : 'bg-[var(--bg-surface-hover)] text-muted-foreground hover:bg-[var(--accent)]'
                }`}
              >
                {f.label}
              </Button>
          ...
          <div className="w-px h-6 bg-[var(--accent)] hidden sm:block" />

          {/* Type filter */}
          <Select
            value={typeFilter}
            onChange={(e) => { setTypeFilter(e.target.value); setPage(1); }}
            className="px-3 py-1.5 rounded-lg text-xs font-medium border border-[var(--border)] bg-[var(--bg-surface-hover)] text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors"
          >
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-[var(--border)] bg-[var(--bg-surface-hover)] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
              />
            ...
            {showEmployeeDropdown && employeeOptions.length > 0 && (
              <div className="absolute z-20 mt-1 w-full rounded-lg border border-[var(--border)] bg-[var(--bg-surface-hover)]/90 backdrop-blur-xl shadow-lg max-h-48 overflow-y-auto">
                {employeeOptions.map((emp) => (
                  <Button
                    key={emp.id}
                    type="button"
                    onClick={() => selectEmployee(emp)}
                    className="w-full text-left px-3 py-2 text-sm hover:bg-[var(--bg-surface-hover)] transition-colors flex items-center gap-2"
                  >
          ...
          <div>
            ...
            <Input
              ...
              className="w-full px-3 py-2 text-sm rounded-lg border border-[var(--border)] bg-[var(--bg-surface-hover)] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
            />
          </div>
