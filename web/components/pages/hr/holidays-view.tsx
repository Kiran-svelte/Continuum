  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: 5 }).map((_, i) => (
        <div
          key={i}
          className="flex items-center gap-4 p-4 rounded-lg bg-[var(--bg-surface-hover)] animate-pulse"
        >
          <div className="h-4 w-40 bg-[var(--accent)] rounded" />
          <div className="h-4 w-32 bg-[var(--accent)] rounded" />
          <div className="h-5 w-16 bg-[var(--accent)] rounded-full" />
          <div className="ml-auto h-8 w-20 bg-[var(--accent)] rounded" />
        </div>
      ))}
    </div>
  );
...
function StatusMessage({
  ...
  return (
    ...
    >
      ...
      <Button
        onClick={onDismiss}
        className="p-0.5 hover:bg-[var(--bg-surface-hover)] rounded"
      >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="absolute inset-0 bg-[var(--accent)]/70 backdrop-blur-sm"
        onClick={onClose}
      />
      <motion.div
      ...
      >
        <GlassPanel className="border-[var(--border)] shadow-xl">
          <div className="p-6 border-b border-[var(--border)] pb-4">
            <div className="flex items-center justify-between">
              ...
              <Button
                onClick={onClose}
                className="p-1.5 hover:bg-[var(--bg-surface-hover)] rounded-lg transition-colors"
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-[var(--border)] bg-background text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors"
                  autoFocus
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-[var(--border)] bg-background text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors"
                />
              </div>
              {error && (
...
export default function HolidaysView() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      >
        <GlassPanel className="border-[var(--border)]">
          <div className="p-6 border-b border-[var(--border)] pb-3">
                              ...
                              {holiday.is_custom ? (
                                <div className="flex items-center justify-end gap-1 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                  <Button
                                    ...
                                    className="p-1.5 hover:bg-[var(--bg-surface-hover)] rounded-md transition-colors text-muted-foreground hover:text-foreground"
                                    title="Edit holiday"
                                  >
