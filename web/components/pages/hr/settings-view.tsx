        ...
        {editing ? (
          <>
            <input
              ...
              className="border border-[var(--border)] bg-[var(--bg-surface-hover)] text-foreground rounded-lg px-2 py-1 text-sm w-32 focus:outline-none focus:ring-2 focus:ring-primary"
              autoFocus
            />
            <Button
              size="sm"
            ...
            <div className="p-6 border-b border-[var(--border)]">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Organization details and configuration</p>
                </div>
          ...
          <GlassPanel>
            <div className="p-6 border-b border-[var(--border)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Invite Employees</h3>
                  <p className="text-sm text-muted-foreground">Add team members via secure invitation links</p>
                </div>
              </div>
            </div>
            <div className="p-6 space-y-4">
          ...
          <GlassPanel>
            <div className="p-6 border-b border-[var(--border)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">HR Preferences</h3>
                  <p className="text-sm text-muted-foreground">Leave policy and approval settings</p>
                </div>
              </div>
            </div>
            <div className="p-6">
        ...
        <GlassPanel>
          <div className="p-6 border-b border-[var(--border)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Auto-Approve Settings</h3>
                <p className="text-sm text-muted-foreground">
        ...
        <GlassPanel>
          <div className="p-6 border-b border-[var(--border)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Organization Notifications</h3>
                <p className="text-sm text-muted-foreground">Configure notification preferences for your organization</p>
              </div>
            </div>
          </div>
          <div className="p-6 space-y-4">
            {([
              ...
              <div
                key={key}
                className="flex items-center justify-between p-3 rounded-lg border border-[var(--border)] hover:bg-[var(--bg-surface-hover)] transition-colors"
              >
                <div className="flex items-center gap-3">
                  {notifications[key] ? (
        ...
        <GlassPanel>
          <div className="p-6 border-b border-[var(--border)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">My Notification Preferences</h3>
                <p className="text-sm text-muted-foreground">Configure how you personally receive notifications</p>
              </div>
            </div>
          </div>
          <div className="p-6 space-y-4">
