                ...
                <div className="md:hidden space-y-3">
                  {reimbursements.map((r) => (
                    <motion.div
                      ...
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="p-4 rounded-lg border border-[var(--border)] hover:bg-[var(--bg-surface-hover)] transition-colors"
                    >
        ...
        <div className="space-y-4">
          <div>
            ...
            <Textarea
              ...
              maxLength={500}
              rows={3}
              className="w-full px-3 py-2 text-sm rounded-lg border border-[var(--border)] bg-[var(--bg-surface-hover)] text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors resize-none"
            />
