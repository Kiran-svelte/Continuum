          ...
          <GlassPanel className="p-8 sm:p-12">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">3.1 Account Creation</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">3.2 Account Security</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">3.3 Account Termination</h3>
                <p className="text-muted-foreground">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">4.1 Pricing</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">4.2 Payment Terms</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">4.3 Refunds</h3>
                <p className="text-muted-foreground">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <ul className="list-none text-muted-foreground space-y-2">
                  <li><strong className="text-foreground/90">Email:</strong> legal@continuum.app</li>
