...
export default function CookiesView() {
  return (
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="bg-card backdrop-blur-xl border-b border-[var(--border)] sticky top-0 z-50">
          ...
          <GlassPanel className="p-8 sm:p-12">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">2.1 Essential Cookies</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] p-4 mb-4 overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-[var(--border)]">
                        <th className="text-left py-2 text-foreground/80">Cookie Name</th>
                        <th className="text-left py-2 text-foreground/80">Purpose</th>
                        <th className="text-left py-2 text-foreground/80">Duration</th>
                      </tr>
                    </thead>
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">2.2 Preference Cookies</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">2.3 Analytics Cookies</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">2.4 Functional Cookies</h3>
                <p className="text-muted-foreground">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
                  <li><strong className="text-foreground/90">Google Analytics:</strong> For website traffic analysis</li>
                  <li><strong className="text-foreground/90">Continuum Auth:</strong> For secure JWT-based authentication services</li>
                  <li><strong className="text-foreground/90">Intercom:</strong> For customer support (if enabled)</li>
                </ul>
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">4.1 Browser Settings</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                  <li><strong className="text-foreground/90">Chrome:</strong> Settings &rarr; Privacy and Security &rarr; Cookies</li>
                  <li><strong className="text-foreground/90">Firefox:</strong> Options &rarr; Privacy &amp; Security &rarr; Cookies</li>
                  <li><strong className="text-foreground/90">Safari:</strong> Preferences &rarr; Privacy &rarr; Cookies</li>
                  <li><strong className="text-foreground/90">Edge:</strong> Settings &rarr; Privacy, search, and services &rarr; Cookies</li>
                </ul>
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">4.2 Cookie Preferences</h3>
                <p className="text-muted-foreground">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
                  <li><strong className="text-foreground/90">Local Storage:</strong> For storing preferences and session data in your browser</li>
                  <li><strong className="text-foreground/90">Session Storage:</strong> For temporary storage during your browsing session</li>
                  <li><strong className="text-foreground/90">Web Beacons:</strong> Small images that help us track email opens and link clicks</li>
                </ul>
              </section>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <ul className="list-none text-muted-foreground space-y-2">
                  <li><strong className="text-foreground/90">Email:</strong> privacy@continuum.app</li>
                  <li><strong className="text-foreground/90">Support:</strong> <Link href="/support" className="text-primary hover:underline">continuum.app/support</Link></li>
                </ul>
              </section>
            </ScrollReveal>
          </GlassPanel>
      ...
      {/* Footer */}
      <footer className="bg-secondary backdrop-blur-xl border-t border-[var(--border)] py-8 relative z-10">
