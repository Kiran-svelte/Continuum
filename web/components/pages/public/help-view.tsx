...
export default function HelpView() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="relative max-w-xl mx-auto">
            ...
            <Input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl bg-card backdrop-blur-sm text-foreground border border-border placeholder:text-muted-foreground focus:border-primary/50 focus:shadow-[0_0_15px_rgba(var(--primary-rgb),0.15)] focus:outline-none"
            />
          </div>
        </div>
        </FadeIn>
          ...
          {VIDEO_TUTORIALS.map((video) => (
            ...
            <GlassPanel className="overflow-hidden cursor-pointer group">
              <div className="aspect-video bg-card relative">
                ...
                <span className="absolute bottom-2 right-2 bg-muted text-foreground text-xs px-2 py-1 rounded">
                  {video.duration}
                </span>
              </div>
              <div className="p-4">
          ...
          {filteredSections.map((section) => (
            ...
            <GlassPanel>
              ...
              <div className="p-6 border-b border-border">
                ...
                <p className="text-sm text-muted-foreground mt-1.5">{section.articles.length} articles</p>
              </div>
              <div className="p-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <GlassPanel className="text-center">
              <div className="p-8">
                <div className="w-14 h-14 rounded-full bg-blue-100 bg-blue-500/20 flex items-center justify-center mx-auto mb-4">
                  <Users className="w-7 h-7 text-blue-600 text-blue-400" />
                </div>
            ...
            <GlassPanel className="text-center">
              <div className="p-8">
                <div className="w-14 h-14 rounded-full bg-green-100 bg-green-500/20 flex items-center justify-center mx-auto mb-4">
                  <CheckCircle className="w-7 h-7 text-green-600 text-green-400" />
                </div>
            ...
            <GlassPanel className="text-center">
              <div className="p-8">
                <div className="w-14 h-14 rounded-full bg-purple-100 bg-purple-500/20 flex items-center justify-center mx-auto mb-4">
                  <Settings className="w-7 h-7 text-purple-600 text-purple-400" />
                </div>
      ...
      {/* Footer */}
      <footer className="bg-card backdrop-blur-xl border-t border-border py-8">
