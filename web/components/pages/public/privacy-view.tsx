          ...
          <GlassPanel className="p-8 sm:p-12">
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">2.1 Personal Information</h3>
                ...
                <h3 className="text-xl font-medium text-foreground/90 mt-6 mb-3">2.2 Automatically Collected Information</h3>
            ...
            <ScrollReveal>
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
                  <li><strong className="text-foreground/90">Within your organization:</strong> With managers, HR, and authorized personnel for leave management purposes</li>
                  <li><strong className="text-foreground/90">Service providers:</strong> With third-party vendors who assist in providing our service</li>
                  <li><strong className="text-foreground/90">Legal compliance:</strong> When required by law or to protect our rights</li>
