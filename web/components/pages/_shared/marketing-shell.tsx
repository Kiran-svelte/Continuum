...
export function MarketingShell({ title, subtitle, children, actions }: MarketingShellProps) {
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-[var(--background)] text-[var(--foreground)]">
      ...
      <section className="mx-auto max-w-6xl px-6 py-14 md:py-20 page-enter">
