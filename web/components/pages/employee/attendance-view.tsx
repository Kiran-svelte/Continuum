    ...
    <StaggerContainer className="space-y-6">
        ...
        action={
          <div className="flex items-center gap-3 flex-wrap">
            <Button
              ...
              variant="outline"
              className="gap-2 border-purple-500/30 text-purple-400 hover:bg-purple-500/10 hover:text-purple-300 font-bold h-11 px-4 rounded-xl shadow-inner transition-all hover:shadow-[0_0_15px_rgba(168,85,247,0.3)] bg-[var(--accent)]"
            >
            ...
            {canCheckIn && (
              <>
                <Button
                  ...
                  disabled={clockingIn}
                  className="bg-primary hover:bg-[var(--accent)] text-foreground hover:text-primary font-bold h-11 px-6 rounded-xl shadow-[0_0_20px_rgba(var(--primary-rgb),0.3)] hover:shadow-[0_0_30px_rgba(var(--primary-rgb),0.3)] gap-2 group relative overflow-hidden transition-all"
                >
                ...
                <Button
                  ...
                  disabled={clockingIn}
                  variant="outline"
                  className="gap-2 border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/10 hover:text-emerald-300 font-bold h-11 px-4 rounded-xl shadow-inner transition-all hover:shadow-[0_0_15px_rgba(16,185,129,0.3)] bg-[var(--accent)]"
                >
            ...
            {canCheckOut && (
              <Button
                ...
                className="bg-rose-500 hover:bg-[var(--accent)] text-foreground hover:text-rose-600 font-bold h-11 px-6 rounded-xl shadow-[0_0_20px_rgba(244,63,94,0.3)] hover:shadow-[0_0_30px_rgba(244,63,94,0.3)] gap-2 group relative overflow-hidden transition-all"
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
        ...
        <FadeIn>
          <TiltCard>
            <GlassPanel>
              <div className="border-b border-[var(--border)] bg-[var(--bg-surface-hover)] px-6 py-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-base text-foreground font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">Attendance Log</h3>
                  <div className="flex items-center gap-2">
                    <Button onClick={prevMonth} className="p-1.5 hover:bg-[var(--accent)] rounded-full transition-colors text-muted-foreground hover:text-foreground" variant="ghost" size="sm">
                      <ChevronLeft className="w-5 h-5 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]" />
                    </Button>
                    <span className="text-sm font-bold text-foreground min-w-[140px] text-center tracking-wider drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
                      {monthNames[currentMonth - 1]} {currentYear}
                    </span>
                    <Button onClick={nextMonth} className="p-1.5 hover:bg-[var(--accent)] rounded-full transition-colors text-muted-foreground hover:text-foreground" variant="ghost" size="sm">
                ...
                <div className="divide-y divide-[var(--border)] max-h-[480px] overflow-y-auto">
                  {records.map((record, index) => (
                    <motion.div
                      ...
                      className="px-6 py-3 hover:bg-[var(--bg-surface-hover)] transition-colors"
                    >
                      <div className="flex items-center justify-between">
                        <div>
        ...
        <FadeIn>
          <TiltCard>
            <GlassPanel>
              <div className="border-b border-[var(--border)] bg-[var(--bg-surface-hover)] px-6 py-4">
                <h3 className="text-base text-foreground font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                  ...
                  {leaveData.balances.map((b, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-full bg-[var(--accent)] rounded-full h-2 overflow-hidden">
                          <motion.div
      ...
      <FadeIn>
        <TiltCard>
          <GlassPanel>
            <div className="border-b border-[var(--border)] bg-[var(--bg-surface-hover)] px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-base text-foreground font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">My Regularization Requests</h3>
      ...
      <AnimatePresence>
        {showRegModal && (
          ...
          >
            {/* Backdrop */}
            <div
              className="absolute inset-0 bg-[var(--bg-surface-hover)]/70 backdrop-blur-sm"
              onClick={() => !regSubmitting && setShowRegModal(false)}
            />

            {/* Modal */}
            <motion.div
              className="relative w-full max-w-md bg-[var(--bg-surface)]/90 backdrop-blur-xl border border-[var(--border)] rounded-2xl shadow-2xl overflow-hidden"
              initial={{ opacity: 0, scale: 0.95, y: 20 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              transition={{ type: 'spring' as const, stiffness: 300, damping: 24 }}
            >
              <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border)] bg-[var(--bg-surface-hover)]">
                <h2 className="text-lg font-semibold text-foreground">Request Regularization</h2>
                <Button
                  onClick={() => !regSubmitting && setShowRegModal(false)}
                  className="p-1.5 rounded-lg hover:bg-[var(--bg-surface-hover)] transition-colors text-muted-foreground hover:text-foreground"
                >
                  <X className="w-4 h-4" />
                </Button>
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="w-full rounded-lg border border-[var(--border)] bg-[var(--bg-surface-hover)] px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={4}
                    maxLength={1000}
                    className="w-full rounded-lg border border-[var(--border)] bg-[var(--bg-surface-hover)] px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors resize-none"
                    disabled={regSubmitting}
                  />
              ...
              <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[var(--border)] bg-[var(--bg-surface-hover)]">
                <Button
                  variant="outline"
                  onClick={() => !regSubmitting && setShowRegModal(false)}
                  disabled={regSubmitting}
                ...
                <Button
                  ...
                  className="bg-purple-600 hover:bg-purple-700 text-foreground shadow-lg shadow-purple-600/20"
                >
