...
export const OPERATIONS_CATEGORIES: OpsCategoryDefinition[] = [
  ...
  { id: 2, category: 'Database Backups', tier: 'critical', why: 'Recover from data loss', completeCriteria: 'Supabase PITR/backups enabled + restore procedure documented' },
  ...
  { id: 14, category: 'Cost Monitoring', tier: 'highly', why: 'Avoid surprise bills', completeCriteria: 'Billing alerts on Vercel/Supabase/Better Stack' },
  ...
  { id: 18, category: 'Database Replication', tier: 'scaling', why: 'High availability', completeCriteria: 'Supabase pooler + direct URLs, HA tier' },
