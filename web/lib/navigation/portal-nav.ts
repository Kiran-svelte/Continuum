...
export const HR_NAV_ITEMS: ModuleNavItem[] = [
  ...
  item({ label: 'Skill Matrix', href: '/hr/skill-matrix', icon: 'Brain', group: 'Learning', moduleSlug: 'learning' }),
  item({ label: 'Career Paths', href: '/hr/career-paths', icon: 'TrendingUp', group: 'Learning', moduleSlug: 'learning' }),
  item({ label: 'Succession Planning', href: '/hr/succession', icon: 'GitMerge', group: 'Performance', moduleSlug: 'performance' }),
  item({ label: 'Loans & Advances', href: '/hr/loans', icon: 'Wallet', group: 'Payroll', moduleSlug: 'payroll' }),
  item({ label: 'Benefits', href: '/hr/benefits', icon: 'Shield', group: 'Payroll', moduleSlug: 'employees' }),
  item({ label: 'Tax Declarations', href: '/hr/tax-declarations', icon: 'Receipt', group: 'Payroll', moduleSlug: 'payroll' }),
  item({ label: 'Policies', href: '/hr/policies', icon: 'BookMarked', group: 'Compliance', moduleSlug: 'compliance' }),
  item({ label: 'Travel & Expense', href: '/hr/travel', icon: 'Plane', group: 'Travel', moduleSlug: 'expenses' }),
  item({ label: 'Announcements', href: '/hr/announcements', icon: 'Megaphone', group: 'Engagement', moduleSlug: 'analytics' }),
  item({ label: 'Surveys', href: '/hr/surveys', icon: 'ClipboardList', group: 'Engagement', moduleSlug: 'performance' }),
  item({ label: 'Workforce Analytics', href: '/hr/workforce-analytics', icon: 'BarChart3', group: 'Reports', moduleSlug: 'analytics' }),
  item({ label: 'Predictive Analytics', href: '/hr/predictive-analytics', icon: 'Brain', group: 'Reports', moduleSlug: 'analytics' }),
  item({ label: 'Workforce Planning', href: '/hr/workforce-planning', icon: 'GitMerge', group: 'Reports', moduleSlug: 'analytics' }),
  item({ label: 'Diversity Metrics', href: '/hr/diversity', icon: 'Users', group: 'Reports', moduleSlug: 'analytics' }),
  item({ label: 'Reports', href: '/hr/reports', icon: 'FileText', group: 'Reports', moduleSlug: 'analytics' }),
  item({ label: 'Report Builder', href: '/hr/report-builder', icon: 'FileSpreadsheet', group: 'Reports', moduleSlug: 'analytics' }),
  item({ label: 'Bulk Operations', href: '/hr/bulk-operations', icon: 'Layers', group: 'Tools', moduleSlug: 'employees' }),
  item({ label: 'Custom Fields', href: '/hr/custom-fields', icon: 'SlidersHorizontal', group: 'Tools', moduleSlug: 'employees' }),
  item({ label: 'Overtime', href: '/hr/overtime', icon: 'Clock', group: 'Attendance', moduleSlug: 'attendance' }),
  item({ label: 'Scheduling', href: '/hr/scheduling', icon: 'Calendar', group: 'Attendance', moduleSlug: 'attendance' }),
...
export const EMPLOYEE_NAV_ITEMS: ModuleNavItem[] = [
  ...
  item({ label: 'Expenses', href: '/employee/expenses', icon: 'Receipt', group: 'Finance', moduleSlug: 'expenses' }),
  item({ label: 'Loans & Advances', href: '/employee/loans', icon: 'Wallet', group: 'Finance', moduleSlug: 'payroll' }),
  item({ label: 'Overtime', href: '/employee/overtime', icon: 'Clock', group: 'Time', moduleSlug: 'attendance' }),
  ...
  item({ label: 'My Skills', href: '/employee/skills', icon: 'Brain', group: 'Growth', moduleSlug: 'learning' }),
  item({ label: 'Career Path', href: '/employee/career-path', icon: 'TrendingUp', group: 'Growth', moduleSlug: 'performance' }),
  item({ label: 'Performance', href: '/employee/performance', icon: 'Target', group: 'Growth', moduleSlug: 'performance' }),
  item({ label: 'Tax Declaration', href: '/employee/tax-declaration', icon: 'Receipt', group: 'Finance', moduleSlug: 'payroll' }),
  item({ label: 'Policies', href: '/employee/policies', icon: 'BookMarked', group: 'Company', moduleSlug: 'compliance' }),
  item({ label: 'Announcements', href: '/employee/announcements', icon: 'Megaphone', group: 'Company', moduleSlug: 'analytics' }),
  item({ label: 'Surveys', href: '/employee/surveys', icon: 'ClipboardList', group: 'Company', moduleSlug: 'performance' }),
