...
export const HR_NAV_ITEMS: ModuleNavItem[] = [
  ...
  item({ label: 'Benefits', href: '/hr/benefits', icon: 'Shield', group: 'Payroll', moduleSlug: 'payroll' }),
  ...
  item({ label: 'Surveys', href: '/hr/surveys', icon: 'ClipboardList', group: 'Engagement', moduleSlug: 'analytics' }),
...
export const EMPLOYEE_NAV_ITEMS: ModuleNavItem[] = [
  ...
  item({ label: 'Surveys', href: '/employee/surveys', icon: 'ClipboardList', group: 'Company', moduleSlug: 'analytics' }),
