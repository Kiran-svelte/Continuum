...
export const ADMIN_NAV_ITEMS: ModuleNavItem[] = [
  ...
  item({ label: 'Directory', href: '/admin/directory', icon: 'Building2', group: 'Organization', moduleSlug: 'directory' }),
...
export const HR_NAV_ITEMS: ModuleNavItem[] = [
  ...
  item({ label: 'Directory', href: '/hr/directory', icon: 'Building2', group: 'People', moduleSlug: 'directory' }),
