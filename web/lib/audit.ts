...
export const AUDIT_ACTIONS = {
  ...
  LEAVE_ENCASHMENT_REQUEST: 'LEAVE_ENCASHMENT_REQUEST',
  LEAVE_ENCASHMENT_APPROVE: 'LEAVE_ENCASHMENT_APPROVE',
  LEAVE_ENCASHMENT_REJECT: 'LEAVE_ENCASHMENT_REJECT',
  ...
  ATTENDANCE_REGULARIZE_APPROVE: 'ATTENDANCE_REGULARIZE_APPROVE',
  ATTENDANCE_REGULARIZE_REJECT: 'ATTENDANCE_REGULARIZE_REJECT',
  ...
  COMPANY_ONBOARDING_COMPLETE: 'COMPANY_ONBOARDING_COMPLETE',
